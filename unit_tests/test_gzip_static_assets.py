...
class TestGzipStaticAssets(unittest.TestCase):
    ...
    @mock.patch("server.custom_extensions.gzip_static_assets.main.GzipStaticAssets.init_app")
    ...
    def test_setting_up_cache_directory(self):
        ...
        file_count = len(list(cache._list_dir()))
    ...
    def test_gzipped_response(self):
        # Create test file
        filename = "server/assets/dist/gzip-test.css"
