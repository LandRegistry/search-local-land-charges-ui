...
from unit_tests.test_data.mock_land_charge import mock_land_charge, mock_paid_land_charge, \
    mock_financial_charge, mock_paid_financial_charge, mock_land_compensation_charge, \
    mock_paid_land_compensation_charge, mock_financial_csv, mock_land_compensation_csv
...
class TestPaidResultsFormatter(TestCase):
    ...
    def test_light_obstruction_notice_charge_format_xml(self):
        ...
        self.assertEqual(self.text_for_tag(xml, 'servient-land-interest-description'), 'land interest description')
    ...
    def test_no_charges(self):
        ...
        charge_formatter = PaidResultsFormatter(mock_charges)
        converted_charges = charge_formatter.to_json()
        self.assertEqual(converted_charges, {
            'result': 'There are 0 local land charges in this area'
        })
